          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12 }}>
              <Stack spacing={2.5}>
                ...
                >
                  รวมรายการซอร์สโค้ด เทมเพลต และชุดคอมโพเนนต์ไว้ให้เลือกดูในหน้าเดียว
                  เพื่อให้คุณค้นหาเทคโนโลยีที่ต้องการ กรองตามเงื่อนไข เปรียบเทียบราคา
                  และตัดสินใจซื้อได้สะดวกจากหน้าหลักทันที
                </Typography>
              </Stack>
            </Grid>
          </Grid>
